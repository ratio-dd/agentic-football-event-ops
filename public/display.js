...
function render(data) {
  const tournament = data.tournament; const branding = data.event?.branding || {};
  document.title = `${branding.pageTitle || data.event?.name || "现场活动"} · 现场大屏`;
