...
export function renderParticipant(root, state, api, refresh) {
  const p = state.currentParticipant; const team = state.currentTeam; const branding = state.event?.branding || {};
