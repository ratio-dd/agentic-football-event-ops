...
const teamStatus = (team) => ({ ready_code: "队伍已就绪，等待领取 Workshop 资源", issued: "已领取 Workshop 资源", ta_qualified: "已确认进入比赛" }[team?.status] || "队伍已就绪");
